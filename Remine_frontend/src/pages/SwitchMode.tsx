...
const PROFILES = [
  { role: 'parent', name: '윤정아님', badge: '부모님 모드', color: COLORS.pink, emoji: '👩', desc: '오늘의 건강, 활동 분석, 추억 퀴즈' },
  { role: 'child', name: '딸 지영님', badge: '자녀 모드', color: COLORS.blue, emoji: '👧', desc: '부모님 상태 모니터링, 사진 추가, 메시지' },
] as const
