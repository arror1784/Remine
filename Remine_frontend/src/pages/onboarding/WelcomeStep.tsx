...
export default function WelcomeStep({ onNext }: WelcomeStepProps) {
  return (
    <Screen footer={<PillButton onClick={onNext}>시작하기</PillButton>}>
      <div className="flex h-full min-h-[500px] w-full flex-col items-center justify-center bg-remine-bg px-6">
        <div className="flex w-[245px] flex-col items-start gap-6">
