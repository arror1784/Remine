...
const NOTIFICATIONS = [
  { emoji: '🌸', bg: '#fff7cc', title: '딸 지영님이 사진을 추가했어요', desc: '2019년 봄 나들이 사진이 업로드됐어요.', time: '방금 전', unread: true },
  { emoji: '🧩', bg: '#fff7cc', title: '오늘의 추억 퀴즈가 준비됐어요', desc: '가족 나들이 사진으로 퀴즈를 풀어보세요.', time: '1시간 전', unread: true },
  { emoji: '💬', bg: '#fff7cc', title: '아들 민호님이 댓글을 남겼어요', desc: '이번 주말에 놀러갈게요!', time: '2시간 전', unread: true },
  { emoji: '🚶', bg: '#f2f2ee', title: '오늘 걸음 수가 목표의 65%예요', desc: '조금만 더 걸으면 목표 달성이에요!', time: '오전 11시', unread: false },
  { emoji: '🌙', bg: '#f2f2ee', title: '어젯밤 수면이 안정적이었어요', desc: '7시간 12분 — 평소와 비슷한 수면이에요.', time: '오전 8시', unread: false },
  { emoji: '👧', bg: '#f2f2ee', title: '딸 지영님이 댓글을 달았어요', desc: '엄마 어제 산책 다녀오셨어요?', time: '어제', unread: false },
]
