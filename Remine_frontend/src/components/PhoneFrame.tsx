...
export default function PhoneFrame({ children }: PhoneFrameProps) {
  return (
    <div className="sm:flex sm:h-dvh sm:items-center sm:justify-center sm:bg-remine-surfaceSoft3 sm:p-10">
      <div className="relative mx-auto h-dvh w-full overflow-hidden bg-remine-bg sm:h-[min(852px,100%)] sm:w-[393px] sm:rounded-[54px] sm:border-[12px] sm:border-remine-nearBlack sm:shadow-[0_30px_70px_rgba(0,0,0,0.3)]">
        <div className="pointer-events-none absolute left-1/2 top-0 z-30 hidden h-[30px] w-[126px] -translate-x-1/2 rounded-b-[18px] bg-remine-nearBlack sm:block" />
