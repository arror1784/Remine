...
export default function BottomTabBar({ role, accentColor }: BottomTabBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-1/2 z-10 flex w-full max-w-[480px] -translate-x-1/2 items-end justify-center border-t border-[#ebebeb] bg-white pb-[max(12px,env(safe-area-inset-bottom))] pt-px">
